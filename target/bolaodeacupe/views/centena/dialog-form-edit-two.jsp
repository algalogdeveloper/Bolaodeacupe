	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-gradient-light">
				<h5 class="modal-title text-uppercase font-weight-bold" id="exampleModalLabel">Modiificar centena</h5>
			...
			<div class="modal-body">
				<form action="controller?operacao=ModificarCentenaGratisTwo"
					...
					<div class="form-group">
						<label for="recipient-name" class="col-form-label font-weight-bolder">Centena:</label>
					...
					<div class="modal-footer">
						<div class="btn-group" role="group" aria-label="Basic example">
								...
								<i class="fas fa-save"> Cadastrar</i>
							</button>
