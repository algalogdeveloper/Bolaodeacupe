				...
				<div class="container-fluid">
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">
							<a href="" data-toggle="modal" 
								...
								data-whateverid="0" 
                                                                class="btn bg-gradient-light border text-uppercase">
								<i class="fas fa-user-friends"> Novo Funcionário</i> </a>
						</h1>
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-7">
							<div class="card mb-2">
								<div class="card-header bg bg-gradient-light font-weight-bold py-1 align-items-center justify-content-between">
