<table class="table table-striped border table-hover text-center text-uppercase" id="dataTable">
            ...
            <c:forEach var="f" items="${funcionarios}">
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <a  <c:if test="${ f.permissao != 4}">  href="controller?operacao=ExcluirFuncionario&acao=<c:out value="${f.idFuncionario}"/>" </c:if>  class="btn btn-danger"> <i
