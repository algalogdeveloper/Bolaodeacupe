				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-xl-11 col-lg-7">
							<div class="card">
								<div class="card-header font-weight-bold">PAINEL DE MILHAR
									COMPRADAS</div>
								<div class="card-body">
									<h1 class="text-center font-weight-bold">Detalhes da
										compras</h1>
									<p class="text-center">
										<a href="controller?operacao=ExibirCartelasNaoPagas"
											class="btn btn-outline-primary font-weight-bold"><i
											class="fas fa-reply-all"></i> Voltar</a>
									</p>


									<c:if test="${not empty info}">
										<p class="text-center alert alert-danger font-weight-bold">
											<c:out value="${info}" />
										</p>
											...
											<tbody>
												<c:forEach var="a" items="${apostas}">
													<tr class="text-center">
														...
														<td><a href="" class="btn btn-outline-success"><i
