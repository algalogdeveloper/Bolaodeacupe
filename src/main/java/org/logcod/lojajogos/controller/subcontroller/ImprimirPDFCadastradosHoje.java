...
public class ImprimirPDFCadastradosHoje implements InvokeSubControllers {
	...
	public String invokePage(HttpServletRequest request, HttpServletResponse response) {
		...
		//	document.setMarginMirroring(true);
			...
			Paragraph texto1 = new Paragraph(new Phrase("Lista de cadastrados do dia - Bolão de Acupe"));
			...
			document.add(texto1);
			document.add(pth3);
			document.add(criarTableModificada2(cs.vizualizarPagamentosHoje()));
			document.add(texto2);
			document.close();
		} catch (Exception e) {
			return "controller?operacao=ImprimirPDFCadastradosHoje";
		}
		return "controller?operacao=ImprimirPDFCadastradosHoje";
	}
	...
	public PdfPTable criarTableModificada2(LinkedHashSet<Compra> listaOrdenadas) throws DocumentException {
